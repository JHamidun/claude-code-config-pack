...
Example entries:
```
2026-03-13 | <owner>/<repo> | fp | app/services/auth_service.rb | race-condition
2026-03-13 | <owner>/<repo> | fix | app/models/user.rb | null-check
2026-03-13 | <owner>/<repo> | already-fixed | lib/payments.rb | error-handling
```
