---
name: threads-post
description: Create and schedule Threads posts with auto-threading, image carousels, and reply control via your social MCP
---

# Threads Post

Create and schedule posts on Meta's Threads using the your social MCP server. Supports auto-threading for long content, image carousels (2-10 images), and reply control settings.
...
2. **Connect Threads** via Instagram OAuth in [SocialPublisher Dashboard](https://your-publisher.example/dashboard)
...
When content exceeds 500 characters, SocialPublisher automatically creates a connected thread:
...
3. **Video carousels not supported**: SocialPublisher's carousel implementation supports images only. Standalone video posts work normally.
...
|-------|-------|----------|
| "Account not connected" | Threads/Instagram OAuth expired | Reconnect via SocialPublisher dashboard |
