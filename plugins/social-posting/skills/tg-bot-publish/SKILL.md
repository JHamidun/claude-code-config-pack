...
- **рассылка** → команда `broadcast` по списку
...
- **`~/.claude/tools/TG_BOT_CAPABILITIES.md`** — разведка возможностей: что доступно one-shot vs нужен живой бот, форматирование, кнопки, рассылка, rich, новинки 2025-2026 по версиям, полный список 62 команд.
