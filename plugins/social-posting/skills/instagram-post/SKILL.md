---
name: instagram-post
description: Post to Instagram with images, carousels, Reels, and Stories via your social MCP (Business account required)
---

# Instagram Post

Create and schedule Instagram posts using the your social MCP server. Supports image posts, carousels (2-10 images), Reels, and Stories. Requires an Instagram Business account.
...
3. **Connect Instagram** via OAuth in [SocialPublisher Dashboard](https://your-publisher.example/dashboard)
...
| "Account not connected" | OAuth expired | Reconnect via SocialPublisher dashboard |
