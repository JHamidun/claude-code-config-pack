---
name: bluesky-post
description: Post to Bluesky with rich text facets, images, videos, and alt text support via your social MCP
---

# Bluesky Post

Create and schedule posts to Bluesky using the your social MCP server. Supports text posts with auto-detected hashtags and URLs, images with alt text, and videos.
...
3. **Connect Bluesky** in [SocialPublisher Dashboard](https://your-publisher.example/dashboard) using your handle + app password
...
Bluesky uses a unique rich text system. SocialPublisher handles the complexity automatically:
