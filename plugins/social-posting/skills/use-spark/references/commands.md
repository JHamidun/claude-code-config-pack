# spark CLI — полный справочник команд

Развёрнутая документация каждой команды `spark`: аргументы, флаги, форматы вывода, примеры.
Читай, когда нужен точный синтаксис команды, список её параметров, значения `--filter`,
уровни доступа аккаунта или формат вывода. Краткая таблица команд и рабочие сценарии —
в `SKILL.md`.
