> **spark-persona-freelancer** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Freelancer / solo operator persona for Spark. Multi-client management, invoice follow-ups, availability, and quick responses.
