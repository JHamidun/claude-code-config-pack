> **spark-recipe-label-organize** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Organize emails with labels and folders: attach labels, detach wrong ones, and move misfiled emails.
