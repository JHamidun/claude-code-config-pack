> **spark-recipe-notification-hygiene** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Tame notification overload by reclassifying noisy senders, grouping repetitive notifications, and bulk-archiving cleared alerts.
