> **spark-recipe-meeting-followup** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Review a meeting transcript and draft follow-up emails with action items to attendees.
