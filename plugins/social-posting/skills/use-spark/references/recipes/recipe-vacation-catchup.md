> **spark-recipe-vacation-catchup** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Process a large email backlog after time away: assess by category, batch-archive noise, and surface what needs attention.
