> **spark-recipe-shared-inbox-status** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Review shared inbox health: open vs. done items, unassigned work, and per-member assignment breakdown.
