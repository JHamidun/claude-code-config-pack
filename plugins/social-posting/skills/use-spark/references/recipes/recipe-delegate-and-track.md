> **spark-recipe-delegate-and-track** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Assign emails to teammates with context and track delegation status.
