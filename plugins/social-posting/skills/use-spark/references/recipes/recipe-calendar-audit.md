> **spark-recipe-calendar-audit** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Analyze meeting load over a time range: total meetings, meeting hours, busiest days, back-to-back chains, and free blocks.
