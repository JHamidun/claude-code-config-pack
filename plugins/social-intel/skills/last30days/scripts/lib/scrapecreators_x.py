"""X/Twitter search via Scraping API for /last30days.

Uses ScraperVendor REST API to search Twitter/X by keyword.
Same API key as Reddit, TikTok, and Instagram - one key covers all social sources.

Requires SCRAPER_API_KEY in config.
...
SCRAPER_BASE = "https://api.your-scraper.example/v1/twitter"
...
def _parse_date(item: Dict[str, Any]) -> Optional[str]:
    """Parse date from ScraperVendor Twitter item to YYYY-MM-DD."""
...
def search_x(
    ...
    """Search X/Twitter via Scraping API.
