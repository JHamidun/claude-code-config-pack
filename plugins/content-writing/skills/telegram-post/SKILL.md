---
name: telegram-post
description: Post to Telegram channels and groups with markdown formatting, media support, and message options via your social MCP
---

# Telegram Post

Create and schedule posts to Telegram channels and groups using the your social MCP server. Supports rich markdown formatting, photos, videos, and message delivery options.
...
5. **Connect in SocialPublisher** at [Dashboard](https://your-publisher.example/dashboard) with bot token and channel name
6. **Get API key** at [your-publisher.example/settings/api](https://your-publisher.example/settings/api)
...
### Scheduled Post
```
Schedule this for tomorrow at your morning time:
