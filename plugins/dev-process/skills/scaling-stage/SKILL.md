---
name: scaling-stage
description: Letterbox-обёртка для контента фиксированного размера (видео, постеры, фиксированные мокапы). Аналог deck-stage для не-слайдов.
when_to_use: Любой артефакт, который рисуется в фиксированном canvas (1920×1080, 1080×1080, 1080×1920) и должен корректно отображаться в любом viewport.
---
