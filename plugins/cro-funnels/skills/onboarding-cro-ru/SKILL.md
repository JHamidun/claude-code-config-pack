...
**Перед началом собери контекст своего продукта:** позиционирование, ядро ценности, длина trial, набор ключевых функций/сценариев, карта воронки. Не дублируй позиционирование и метрики.
...
| Оптимизация регистрации/trial до онбординга | `signup-cro-ru` |
