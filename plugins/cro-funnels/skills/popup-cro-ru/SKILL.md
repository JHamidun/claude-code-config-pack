...
**Перед началом собери контекст своего бизнеса:** лид-магниты, trial продукта, карта воронки. **Частый приоритет — закрыть дыру воронки, где контент-портал не связан с продуктом/консультацией.** Если портал гонит трафик только на соцсети и блог — попапы должны захватывать email и сквозным CTA вести в середину воронки (trial продукта / бесплатная консультация).
