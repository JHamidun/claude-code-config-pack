...
**Перед началом прочитай `~/.claude/business-context.md`** (заведи из `~/.claude/templates/business-context.md`, если файла ещё нет) — структура тарифов и цены (месяц/год, trial-период, спец-офферы, разовые продукты, add-ons), карта воронки. Не дублируй цены и метрики.
