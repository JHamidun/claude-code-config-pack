...
The `medias` order MUST match the `@ImageN` declarations you write into the prompt. Wait with
`jobs_wait`, then run the MANDATORY Seedream de-slop pass from SKILL.md — its output replaces this
board downstream.
