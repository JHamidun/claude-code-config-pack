---
name: session-mentor
description: "Локальный анализ истории сессий Claude Code (и Codex) → HTML-отчёт «как ты работаешь»: темы, использование инструментов, точки трения, недоиспользуемые возможности, правки для CLAUDE.md, метрики и тренды. Данные не покидают машину. НЕ: полнотекстовый поиск по чатам→/search-chats; статистика ОДНОЙ сессии→/prompt-log."
metadata:
  version: 1.0.0
  type: analysis
