...
Для задач под реальный бизнес (AI-консалтинг + воркшопы + ExampleProduct) сначала прочитай `~/.claude/business-context.md` → `business.md`, затем используй references:
