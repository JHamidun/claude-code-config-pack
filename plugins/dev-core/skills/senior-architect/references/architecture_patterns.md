...
Real-world patterns from the your-monorepo codebase.
...
export * from '@your-org/shared-types/database.types';

// packages/your-app/src/types/database.ts (RE-EXPORT ONLY)
export type { Database } from '@your-org/shared-types';
```
...
```
packages/
├── your-app/  # Backend (Node.js, tRPC, BullMQ)
...
**Pattern:**
```
packages/your-app/supabase/migrations/
...
These patterns are extracted from real production code in the your-monorepo. They represent battle-tested solutions to common architectural challenges in modern full-stack TypeScript applications.
