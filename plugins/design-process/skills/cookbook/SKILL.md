---
name: cookbook
description: Готовые сценарии "как от запроса дойти до результата". 5 типовых задач с пошаговым flow и нужными скиллами.
when_to_use: Когда пользователь сформулировал задачу типового вида — питч, прототип, дизайн-система, лендинг, видео.
---
