---
name: design-guide
description: Общий гайд по принципам хорошего дизайна — иерархия, ритм, плотность, копирайт, ответственность. Не процессный скилл, а памятка о вкусе.
when_to_use: Когда хочется вспомнить базовые правила, перед сдачей работы, при сомнениях в направлении.
---
