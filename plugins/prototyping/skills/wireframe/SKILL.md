---
name: wireframe
description: Быстрая разведка — много идей в низкой детализации на одном листе. Перед хи-фи всегда стоит сделать wireframe.
when_to_use: Начало проекта, исследование вариантов структуры, согласование скелета до отрисовки.
---
