---
name: canonical-html
description: Писать HTML канонически — закрытые теги, double-quotes, никаких implied-close. Чтобы инструменты могли править разметку без сюрпризов.
when_to_use: Любой HTML-артефакт. Это правило гигиены, а не отдельная задача.
---
