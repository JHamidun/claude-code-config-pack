...
description: "Промпт-инжиниринг генерации картинок (DALL-E, Midjourney, SD, Gemini) + сюрреализм-пресет эксперта. Триггеры: «креатив для vk ads», «сюрреализм магритт»."
---
