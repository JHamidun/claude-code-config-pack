---
name: content-policy
description: Что НЕ воспроизводить — защищённые UI крупных компаний, бренды без подтверждения. Юридическая и этическая граница.
when_to_use: Любой запрос вида "сделай как в Slack/Notion/Linear/Gmail/Figma".
---
