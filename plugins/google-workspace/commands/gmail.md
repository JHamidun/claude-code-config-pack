---
description: "Gmail (ЛИЧНАЯ почта, 20 ящиков): поиск, чтение, отправка, вложения. Триггеры: «gmail», «личная почта», «письмо», «непрочитанные письма», «отправь письмо». РАБОЧАЯ почта you@company.example → /outlook. Полный набор Workspace → skill google-workspace."
