...
> Pre-configured Claude Code environment: 259 skills, 49 agents, 166 commands, 35 plugins (+3 disabled), 19 local MCP + 10 cloud MCP servers.
...
1. **Commands**: type `/help` to see all 166 available slash commands
...
|---------|-------|------------|
| **Skills** | 259 | Prompt templates in `~/.claude/skills/*/SKILL.md` — enhance Claude's domain expertise |
| **Agents** | 49 | Specialized subagents (code-reviewer, bug-hunter, test-writer) — auto-delegated by complexity |
| **Commands** | 166 | Slash commands (`/deploy`, `/translate`, `/gmail`) — shortcuts for common workflows |
