...
metadata:
  ...
  reuses: html-email, n8n, ab-testing-ru
---
...
**Метрики активации:** % регистраций trial, дошедших до активации; время до активации; шаги до активации; активация по когортам/источникам. Считать в своей веб-аналитике (счётчик — раздел «Учёт и аналитика» в `~/.claude/business-context.md`).
