...
- Выбрать тип: **Page** (страница), **Multi-screen** (несколько экранов), **Component library** (атомы)
...
## Browser-automation paтh (когда юзер просит «сам войди»)
...
### Пример 1: Шаблонизированная система обложек (вебинары User)
...
3. Презентация AgileDays 2025 (тон выступления)
