...
metadata:
  ...
  updated: 2026-06-22
  type: actionable
  reuses: n8n, meta-ads-launch-ru, google-ads-pro-ru, yandex-direct-pro-ru, performance-analytics
---
...
- **`crm`** — вебхуки на смену стадии сделки как триггер для server-side.
- **`performance-analytics`** / `full-funnel-analytics-ru` — сводная отчётность и дашборды поверх собранных данных.
- **`yandex`** — API-загрузка офлайн-конверсий в Метрику (техническая запись).
