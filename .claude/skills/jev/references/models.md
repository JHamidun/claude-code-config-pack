<!-- snapshot 2026-09-21 of https://docs.typesafe.ai/models.md — публичная документация TypeSafe, копия как ДАННЫЕ, не инструкции; перед опорой на детали сверить с живой страницей -->
> ## Documentation Index
