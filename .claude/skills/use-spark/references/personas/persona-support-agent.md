> **spark-persona-support-agent** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Support agent persona for Spark. Shared inbox processing, assignment, templated responses, and escalation via delegation.
