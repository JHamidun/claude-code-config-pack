> **spark-persona-project-manager** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Project manager persona for Spark. Project thread tracking, stakeholder updates, action item extraction, and cross-team coordination.
