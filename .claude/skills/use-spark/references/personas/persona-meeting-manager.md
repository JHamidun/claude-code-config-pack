> **spark-persona-meeting-manager** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Meeting manager persona for Spark. Meeting preparation, transcript review, follow-up drafts, and scheduling.
