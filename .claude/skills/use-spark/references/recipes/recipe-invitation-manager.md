> **spark-recipe-invitation-manager** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Process pending calendar invitations: check availability and present a decision list with recommendations.
