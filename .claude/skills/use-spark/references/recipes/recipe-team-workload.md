> **spark-recipe-team-workload** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Audit team assignment distribution: per-member loads, delegated items, unassigned work, and workload imbalances.
