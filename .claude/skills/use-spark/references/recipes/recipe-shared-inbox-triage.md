> **spark-recipe-shared-inbox-triage** v1.0.0 · access level: triage · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Process open items in shared inboxes: review, assign, respond, or mark done.
