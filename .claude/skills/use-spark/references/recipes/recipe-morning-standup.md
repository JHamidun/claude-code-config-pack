> **spark-recipe-morning-standup** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Morning standup briefing: today's events, unread people and priority mail, and team assignment status.
