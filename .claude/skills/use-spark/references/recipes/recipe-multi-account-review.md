> **spark-recipe-multi-account-review** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Review inbox status across multiple email accounts with per-account breakdown and cross-account priorities.
