> **spark-recipe-end-of-day** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — End-of-day review: check for loose ends, review pinned items, and preview tomorrow's calendar.
