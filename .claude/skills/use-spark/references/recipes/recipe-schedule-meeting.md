> **spark-recipe-schedule-meeting** v1.0.0 · access level: read-only · base skill: use-spark · source: spark-cli-skills 1.3.0 (Readdle, MIT) — Find mutual availability with attendees and suggest meeting times.
