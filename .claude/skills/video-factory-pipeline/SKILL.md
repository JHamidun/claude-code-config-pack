...
(схема: `~/.claude/skills/video-montage/schemas/production.schema.json`).
...
`~/.claude/skills/video-montage/references/pipeline-architecture.md`.
...
Из каталога приёмов (`~/.claude/skills/video-montage/scripts/techniques.json`, 79 записей
