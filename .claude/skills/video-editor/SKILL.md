---
name: video-editor
description: Локальный видеомонтаж на FFmpeg+Python: базовый + профи-набор — вырезка тишины/дублей, виральные субтитры, переходы, цветокор/LUT, авто-рефрейм 16:9→9:16; плюс overlay-рил talking-head + AI b-roll. Use when: «смонтируй», «монтаж», «склей видео», «вырежи паузы/дубли», «субтитры на видео», «цветокор/LUT», «сделай вертикалку/9:16», «рилс из видео блогера». НЕ: генерация AI-видео→video-generation.
type: actionable
---
