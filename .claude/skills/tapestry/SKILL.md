---
name: tapestry
description: "Tapestry — Knowledge Weaving"
---
...
|-------------|-----------------|------|
| YouTube | `youtube-transcript.md` | Tapestry weave |
| Articles | `content-research.md` | Tapestry weave |
| PDFs | `document-skills/pdf/` | Tapestry weave |
| Code | `code-reviewer/` | Tapestry weave |
