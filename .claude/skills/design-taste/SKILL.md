---
name: design-taste
description: "Количественный контроль дизайн-вкуса для лендингов/портфолио/редизайнов — 3 шкалы 1-10 (DESIGN_VARIANCE/MOTION_INTENSITY/VISUAL_DENSITY) + сканер AI-tells. Триггеры: «настрой вкус/плотность/движение», «проверь на ИИ-шаблонность», «анти-slop», «не как типовой AI-лендинг». НЕ для дашбордов/таблиц/wizard-форм (design-system из design-orchestrator); финальная проверка результата → design-guardrails."
when_to_use: |
  Дизайн лендинга, портфолио, маркетинг-страницы или редизайна существующего сайта, где нужна количественная
