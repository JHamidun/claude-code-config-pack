...
Step-by-step workflows for common system design tasks in the your-monorepo.
...
// 3. tRPC router
// packages/your-app/src/server/routers/enrichments.ts
...
packages/your-app/supabase/migrations/YYYYMMDD_add_enrichments.sql

# 3. Backend implementation
packages/your-app/src/server/routers/enrichments.ts
packages/your-app/src/stages/stage7-enrichments/
...
# Node.js profiling
node --inspect packages/your-app/dist/server.js
...
```typescript
// packages/your-app/src/server/routers/courses.ts
import { router, publicProcedure } from '../trpc';
import { CreateCourseSchema } from '@your-org/shared-types';
...
```typescript
// packages/your-app/src/server/routers/_app.ts
...
```typescript
// packages/your-app/tests/routers/courses.test.ts
...
pnpm --filter your-app add bullmq
...
// packages/web/package.json
{
  "dependencies": {
    ...
    "@your-org/trpc-client-sdk": "workspace:*"
  }
}
```
