...
- **Лиды/quality из CRM как guardrail** → твоя CRM (какая — раздел «Учёт и аналитика» в `~/.claude/business-context.md`; у Битрикс24/amoCRM/HubSpot есть REST API для выгрузки).
