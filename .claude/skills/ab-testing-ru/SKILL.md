---
name: ab-testing-ru
description: "A/B-тесты и программа роста через эксперименты: гипотезы, размер выборки, статзначимость, ICE, плейбук; A/B автостратегий контекстной рекламы и подрядчиков. Триггеры: «A/B тест», «сплит-тест», «эксперимент», «размер выборки», «статзначимость», «ICE», «программа экспериментов». НЕ: аналитика/трекинг→performance-analytics; CRO-аудит страниц→page-cro-ru и *-cro-ru."
metadata:
  version: 1.1.0
  updated: 2026-06-23
  type: actionable
  reuses: yandex, performance-analytics
---
...
|-----------|-------|--------------|
| `references/hypothesis-template-instructor2.md` | Шаблон гипотезы «3 гипотезы × 2-3 недели + объяснение»: формат гипотезы, почему именно 3, как формулировать ожидаемый эффект от бенчмарка (не от потолка), ICE-оценка с реальной калибровкой шкалы | Нужно сформировать бэклог гипотез под продукт, оформить гипотезу проверяемо, приоритизировать по ICE |
