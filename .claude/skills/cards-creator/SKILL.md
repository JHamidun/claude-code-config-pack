...
--primary: #YOUR_PRIMARY;   /* Primary accent */
--deep: #YOUR_INK;      /* Deep navy */
--cyan: #YOUR_ACCENT;      /* Highlight cyan */
--cyan-soft: #B5E1FF;
--cream: #YOUR_CREAM;     /* Base — большинство карточек */
--cream-warm: #EFE6D6;
--cream-deep: #E8DDC6;
--ink: #18181B;
...
- **bar-chart (A vs B)**: горизонтальные пары баров (baseline `#BCAE8E` / актуал `#YOUR_PRIMARY`), ширина = `val/max*100%`, цифра в конце бара, дельта-чип справа (`+8.5` зелёным).
