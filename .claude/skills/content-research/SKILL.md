...
description: Исследование под контент — поиск и верификация источников, CRAAP-оценка, цитирование, fact-checking. Триггеры — «найди источники», «проверь факты для статьи», «собери research для поста/доклада», «нужны цитаты с пруфами», «fact-check». НЕ для — глубокого многошагового рисёрча с отчётом-лонгридом (→ /deep-research), проверки уже написанного текста на галлюцинации (→ check-skill-solo), анализа документов из папки (→ research-docs).
---
