...
- **Trial→paid конверсия, показы/клики пейволла, сегменты, revenue, апгрейды тарифов** → твоя веб-аналитика (Метрика/GA; счётчик — в `~/.claude/business-context.md`) + продуктовая БД; платежи — вебхуки платёжного провайдера.
