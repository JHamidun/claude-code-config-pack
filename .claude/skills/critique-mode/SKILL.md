---
name: critique-mode
description: Не делать дизайн, а критиковать готовый. Конкретно, по чеклисту, без "выглядит хорошо".
when_to_use: Пользователь показывает свой или чужой макет и просит обратной связи.
---
...
- [ ] У основного заголовка есть >2× разница в размере с soseдним текстом?
