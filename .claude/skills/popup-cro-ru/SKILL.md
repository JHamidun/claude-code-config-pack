...
metadata:
  version: 1.1.0
  updated: 2026-05-29
  ported_from: coreyhaines31/marketingskills (popups)
  reuses: form-cro-ru, page-cro-ru, html-email, n8n, ab-testing-ru
---
...
**Перед началом прочитай `~/.claude/business-context.md`** (заведи из `~/.claude/templates/business-context.md`, если файла ещё нет) — лид-магниты, trial продукта, карта воронки. **Частый приоритет — закрыть дыру воронки, где контент-портал не связан с продуктом/консультацией.** Если портал гонит трафик только на соцсети и блог — попапы должны захватывать email и сквозным CTA вести в середину воронки (trial продукта / бесплатная консультация).
...
- Данные — твоя веб-аналитика (Метрика/GA: цель на сабмит попапа; счётчик — в `~/.claude/business-context.md`) + таблица подписчиков.
