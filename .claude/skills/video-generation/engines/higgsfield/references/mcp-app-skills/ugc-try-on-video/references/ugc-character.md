...
**Bad:** "an adult woman holding a skincare bottle in a bathroom, smiling" — model bakes the bottle into the image, downstream compositing fails.
**Good:** "an adult woman, age 25, natural appearance, friendly smile, casual style, modern bathroom background" — clean person, product added at video step.
...
**2. Anatomy & clothing.**
If `user_overrides` requests nudity, intimate apparel, sexualized styling, or
focuses on intimate anatomy, stop and return to the parent skill's suitability
gate. Do not compose a character prompt and do not transform the request into a
different outfit.
