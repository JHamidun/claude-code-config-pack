...
// GOOD -- configure it through Higgsfield website settings
...
| Hardcoded string resembling a key (`sk-`, `ghp_`, `Bearer`) | Secret in source code / git history | Higgsfield website settings + `bindings().SECRET_NAME` server-side |
