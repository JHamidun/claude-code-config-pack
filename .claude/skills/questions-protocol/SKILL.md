...
description: Когда задавать уточняющие вопросы и какие. Хорошие вопросы экономят 80% времени работы.
when_to_use: В начале новой задачи, особенно если бриф короткий или неоднозначный. Не использовать для мелких правок.
---
