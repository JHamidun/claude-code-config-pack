...
Инструменты:
```bash
python ~/.claude/skills/video-editor/scripts/transitions.py --list        # 44 встроенных
python ~/.claude/skills/video-editor/scripts/transitions_pro.py --list    # 8 сверх того
...
```bash
python ~/.claude/skills/video-editor/scripts/font_catalog.py pick caption --cyrillic
python ~/.claude/skills/video-editor/scripts/font_catalog.py list --role display --cyrillic
```
