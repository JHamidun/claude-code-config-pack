...
```bash
python ~/.claude/skills/video-generation/scripts/direct_video.py models      # что доступно
python ~/.claude/skills/video-generation/scripts/direct_video.py plan shots.json -o dir/
```
